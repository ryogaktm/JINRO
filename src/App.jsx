...
③fortunes:そのタロットカードの一般的な象徴・意味合いに沿って、今日から向こう1週間程度を想定した**気軽な占い**として、金運・仕事運・恋愛運・健康運・総合運の5項目を生成する。各項目は{"stars": 1〜5の数値(星の数、5が最高), "text": "一言占い文(20〜35字程度、前向きで具体的な一言。当たり障りのない一般論ではなく、そのタロットカードらしい個性を反映させる)"}の形式。深刻になりすぎず、エンタメとして楽しめる軽いトーンにする。
